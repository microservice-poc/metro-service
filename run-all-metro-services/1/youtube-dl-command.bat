...
set COMMAND=%COMMAND% --sleep-interval 45 --max-sleep-interval 75 
...
set COMMAND=%COMMAND% "https://www.lynda.com/Art-Illustration-tutorials/Painting-Foundations-Light-Landscape/553022-2.html"
